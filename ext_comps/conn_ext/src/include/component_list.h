...
DECLARE_MAIN_FUNC(conn_ext_main);
DECLARE_HANDLER_FUNC(conn_ext_handler);
DECLARE_CLEANUP_FUNC(conn_ext_cleanup);
DECLARE_CLI_FUNC(conn_ext_cli);
...
struct _compnt_func_t {
    ...
    {"conn_ext", conn_ext_main, conn_ext_handler, conn_ext_cleanup, conn_ext_cli},
