...
struct cli_def *cli_init() {
    ...
    c = cli_register_command(cli, 0, "turn", NULL, PRIVILEGE_UNPRIVILEGED, MODE_EXEC, NULL);
    cli_register_command(cli, c, "on", cli_int_enable, PRIVILEGE_UNPRIVILEGED, MODE_EXEC,
                                             "Turn on privileged commands");
    cli_register_command(cli, c, "off", cli_int_disable, PRIVILEGE_PRIVILEGED, MODE_EXEC,
